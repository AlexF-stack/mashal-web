...
export const fr = {
  ...
  home: {
    ...
    findEyebrow: "Catalogue",
    findTitle: "Trouver une machine",
    findText: "Parcourez les familles d'engins et demandez une qualification technique.",
    trustResponse: "Réponse sous 24 h",
    trustExport: "Export international",
    trustParts: "Pièces sur demande",
    ...
    partsText: "Identification, compatibilité et délai confirmés avant commande.",
    ...
    catalogTitle: "Références à qualifier",
    catalogText: "Fiches issues du catalogue officiel — disponibilité et configuration confirmées sur devis.",
  ...
  catalogTeaser: {
    eyebrow: "Catalogue machines",
    title: "Un catalogue, pas notre seule activité",
    text: "52 références du catalogue officiel à qualifier sur devis — Mashal intervient surtout sur la formation, le SAV, les pièces et le pilotage de vos chantiers.",
  ...
  chat: {
    ...
    footer: "Assistant guidé · parcours services & catalogue",
    welcome:
    ...
    product: {
      ...
      pickModel: "Sélectionnez un modèle pour voir la fiche.",
    ...
    replies: {
      training:
        "Formation opérateurs : qualification, programme sur mesure, session et rapport. Demandez un devis pour planifier.",
      consulting:
        "Consultation technique : audit de parc, diagnostic et plan d'action. Décrivez votre contexte pour démarrer.",
      sav: "SAV : ouvrez un ticket avec modèle, heures, symptômes et urgence — nous organisons l'intervention.",
      parts:
        "Pièces : envoyez machine, référence ou photos — nous confirmons compatibilité et délai avant commande.",
      sites:
        "Gestion de chantier : brief projet, ressources et suivi terrain. BTP, mines ou hydraulique.",
      machines:
        "Catalogue de références à qualifier sur devis. Parcourez par catégorie ou tapez un modèle.",
      contact:
    ...
    machines: {
      ...
      description:
        "52 engins du catalogue officiel Mashal — disponibilité, configuration et délai confirmés sur devis. La vente complète la formation, le SAV et la gestion de chantier.",
    ...
    pieces: {
      ...
      description:
        "Filtres, hydraulique, train de roulement et kits d'usure — chaque demande est vérifiée avant confirmation.",
      primary: "Demander une pièce",
      secondary: "Conseils pièces",
      availEyebrow: "Sur devis",
      availTitle: "Identifiez vite la bonne référence",
      availText:
        "Préparez : machine, moteur, référence éventuelle, urgence, localisation et photos. Nous confirmons compatibilité et délai — sans stock fictif en ligne.",
      familiesEyebrow: "Familles de pièces",
      familiesTitle: "Trois familles critiques",
      stockEyebrow: "Demande",
      stockTitle: "Commande pièces",
    ...
    outils: {
      ...
      title: "Aides à la",
      highlight: "décision",
      description: "Estimateurs indicatifs pour préparer vos projets — un devis Mashal reste nécessaire pour valider.",
  ...
  machines: {
    ...
    subtitle: "Références équipements lourds — sur devis",
...
export const en: typeof fr = {
  ...
  home: {
    ...
    partsText: "Identification, compatibility and lead time confirmed before order.",
    ...
    catalogTitle: "References to qualify",
    catalogText: "Sheets from the official catalog — availability and configuration confirmed on quote.",
  ...
  catalogTeaser: {
    eyebrow: "Machine catalog",
    title: "A catalog — not our only business",
    text: "52 official catalog references to qualify on quote — Mashal focuses on training, support, parts and site management.",
    cta: "View catalog",
  },
  chat: {
    ...
    footer: "Guided assistant · services & catalog",
    welcome:
    ...
    replies: {
      training:
        "Operator training: qualification, custom program, session and report. Request a quote to schedule.",
      consulting:
        "Technical consulting: fleet audit, diagnostics and action plan. Describe your context to start.",
      sav: "After-sales: open a ticket with model, hours, symptoms and urgency — we organize the intervention.",
      parts:
        "Parts: send machine, reference or photos — we confirm compatibility and lead time before order.",
      sites:
        "Site management: project brief, resources and field follow-up. Construction, mining or hydraulics.",
      machines:
        "Catalog of references to qualify on quote. Browse by category or type a model.",
      contact:
  ...
  pages: {
    machines: {
      ...
      description:
        "52 units from the official Mashal catalog — availability, configuration and lead time confirmed on quote. Sales complement training, after-sales and site management.",
    ...
    pieces: {
      ...
      description:
        "Filters, hydraulics, undercarriage and wear kits — every request is verified before confirmation.",
      primary: "Request a part",
      secondary: "Parts advice",
      availEyebrow: "On quote",
      availTitle: "Identify the right reference fast",
      availText:
        "Prepare: machine, engine, optional SKU, urgency, location and photos. We confirm fit and lead time — no fake online stock.",
      familiesEyebrow: "Part families",
      familiesTitle: "Three critical families",
      stockEyebrow: "Request",
      stockTitle: "Parts order",
